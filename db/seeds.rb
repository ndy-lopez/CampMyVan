...
van1 = Van.create(brand: 'Volkswagen', model: 'California', price: 60000, user_id: user1.id)
van2 = Van.create(brand: 'Mercedes', model: 'Marco Polo', price: 100000, user_id: user2.id)
van3 = Van.create(brand: 'Nissan', model: 'NV Camper', price: 70000, user_id: user3.id)
